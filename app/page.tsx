...
export default function Page() {
    ...
    const paragraphs = generatedBios?.split("\n");
    return (
                ...
                <form className="max-w-xl w-full" onSubmit={onSubmit}>
                    <div className="flex mt-10 items-center space-x-3">
                        <p className="text-left font-medium">
                            1. Input the ingridients you have or want to use. Or
                            input "nothing", if you don't care about the
                            ingredients.
                    ...
                    <textarea
                        ...
                        placeholder={
                            "e.g. chicken breast fillet, brown rice, etc."
                        }
                    />
                    ...
                    <div className="block">
                        <DropDown
                            diet={diet}
                            setDiet={(newDiet) => setDiet(newDiet)}
                        />
                    </div>
                    {!isLoading && (
                        <button
